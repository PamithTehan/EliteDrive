            ...
            <aside>
                <div class="profile-user-card">
                    ...
                    <div class="profile-meta-list" style="margin-bottom: 24px;">
                        ...
                        <a href="<?= baseUrl('/admin/disputes.php') ?>" style="display:flex; align-items:center; gap:8px; color: var(--color-primary); text-decoration: none; padding: 8px 12px; border-radius: 6px; background-color: #e0e7ff; font-weight: 600;">
