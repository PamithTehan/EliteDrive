            ...
            <aside>
                <div class="profile-user-card" style="padding: 24px 16px;">
                    <div class="profile-meta-list">
                        ...
                        <a href="<?= baseUrl('/admin/income.php') ?>" style="display:flex; align-items:center; gap:8px; color: var(--color-primary); text-decoration: none; padding: 8px 12px; border-radius: 6px; background-color: #e0e7ff; font-weight: 600;">
