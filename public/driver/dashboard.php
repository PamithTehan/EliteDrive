...
<div class="container grid grid-3" style="margin-top: var(--space-lg); margin-bottom: var(--space-lg);">
    ...
    <main class="dashboard-content" style="grid-column: 2 / 4;">
        ...
        <h2 class="headline-md" style="margin-top: var(--space-xl); margin-bottom: var(--space-md);">My Reviews</h2>
        <?php if (empty($reviews)): ?>
            <div class="card">
                <div class="card-body" style="text-align:center; padding: var(--space-lg);">
                    <p class="body-lg" style="color:var(--color-secondary);">You have no reviews yet.</p>
                </div>
            </div>
        <?php else: ?>
            <div class="stack-md">
